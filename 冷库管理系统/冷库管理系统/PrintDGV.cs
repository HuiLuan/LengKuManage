...
//                if (dlg.ShowDialog() != DialogResult.OK) return;
                ...
                PrintTitle = "金正果蔬";//dlg.PrintTitle;
                ...
                list.Add("冷藏费");
                list.Add("实际金额");
                SelectedColumns = list;//dlg.GetSelectedColumns();
                    ...
                    else
                    {
                        if (NewPage)
                        {
                            ...
                            foreach (DataGridViewColumn GridCol in dgv.Columns)
                            {
                                ...
                                var font = new Font(GridCol.InheritedStyle.Font.FontFamily, 8);

                                if (GridCol.HeaderText == "单价（元/公斤）")
                                {
                                    font = new Font(GridCol.InheritedStyle.Font.FontFamily, 6);
                                }
...
//                                var font = Cel.InheritedStyle.Font;
                                var font=new Font(Cel.InheritedStyle.Font.FontFamily,8);
                                e.Graphics.DrawString(cellValue, font,
